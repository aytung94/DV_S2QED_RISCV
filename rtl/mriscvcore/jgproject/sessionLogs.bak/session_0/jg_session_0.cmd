...
include {/home/ecelrc/students/atung/verif_labs/project_clean/DV_S2QED_RISCV/rtl/mriscvcore/jg_mriscvcore.tcl}
include {/home/ecelrc/students/atung/verif_labs/project_clean/DV_S2QED_RISCV/rtl/mriscvcore/jg_mriscvcore.tcl}
visualize -property {<embedded>::mriscvcore_top_s2qed.S2QED_BIND.[0].asm_S2QED_SAME_REG_N_STATE:precondition1} -new_window
visualize -property {<embedded>::mriscvcore_top_s2qed.S2QED_BIND.[0].ast_S2QED_SAME_REG_N_STATE:precondition1} -new_window
...
visualize -min_length [expr [visualize -get_length -window visualize:1] + 1] -window visualize:1; visualize -freeze [visualize -get_length -window visualize:1] -window visualize:1; visualize -replot -bg -window visualize:1
visualize -min_length [expr [visualize -get_length -window visualize:1] + 1] -window visualize:1; visualize -freeze [visualize -get_length -window visualize:1] -window visualize:1; visualize -replot -bg -window visualize:1
visualize -min_length [expr [visualize -get_length -window visualize:1] + 20] -window visualize:1; visualize -freeze [visualize -get_length -window visualize:1] -window visualize:1; visualize -replot -bg -window visualize:1
